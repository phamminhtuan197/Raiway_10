...
public class FunctionAccount {
	...
	public void showAccountByName() throws ParseException {
		do {
	...
	public void showAccountByID() throws ParseException {
		do {
	...
	public void showAllAccount() throws ParseException {
	...
	public void showFullNameOfAccount() throws ParseException {
		do {
			AccountController accountController = new AccountController();
	...
	public void showAccountByCurrentMonth() throws ParseException {
	...
	public void updateEmailUsernameAccountByID() throws ParseException {
		do {
			AccountController accountController = new AccountController();
	...
	public void deleteAccountByEmail() throws ParseException {
		do {
			AccountController accountController = new AccountController();
