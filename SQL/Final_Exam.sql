...
(4, 'Mellie Undrell', 'mundrell3@discovery.com', 'uJuzOi0dJ2OF', 'ADMIN'),
(5, 'Delmar Leidecker', 'dleidecker4@wix.com', 'yaCypg', 'EMPLOYEE'),
(6, 'Finlay McGrirl', 'fmcgrirl5@scribd.com', '95Hw0Y', 'ADMIN'),
(7, 'Glenden Solon', 'gsolon6@digg.com', '3Zvq3q', 'EMPLOYEE'),
(8, 'Cull Laimable', 'claimable7@mozilla.org', 'S7FsX15cD', 'EMPLOYEE'),
(9, 'Georgina Henrys', 'ghenrys8@cloudflare.com', 'mPMCdFefk8UN', 'ADMIN'),
